<%-- 
    Document   : bai-tap-9
    Created on : Apr 3, 2017, 9:42:12 AM
    Author     : hv
--%>
...
<html>
    ...
    <body>
        <div id="container">
        <form name="frmTimKiem" action="TimSuaTheoTenMaHangController" method="get">
            <table border="1" width="100%">
                ...
                <tbody>
                    <tr>
                        <td><myTag:loaisua></myTag:loaisua></td>
                        <td><myTag:hangsua></myTag:hangsua></td>
                    </tr>
                    <tr>
